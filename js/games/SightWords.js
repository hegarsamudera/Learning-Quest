...
/**
 * SightWords — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for SightWords) without touching
 * the shared engine.
 */
export class SightWords extends QuizGame {}
