...
/**
 * Spelling — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for Spelling) without touching
 * the shared engine.
 */
export class Spelling extends QuizGame {}
