...
/**
 * NounsVerbs — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for NounsVerbs) without touching
 * the shared engine.
 */
export class NounsVerbs extends QuizGame {}
