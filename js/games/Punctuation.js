...
/**
 * Punctuation — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for Punctuation) without touching
 * the shared engine.
 */
export class Punctuation extends QuizGame {}
