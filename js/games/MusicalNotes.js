...
/**
 * MusicalNotes — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for MusicalNotes) without touching
 * the shared engine.
 */
export class MusicalNotes extends QuizGame {}
