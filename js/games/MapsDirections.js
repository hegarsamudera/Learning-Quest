...
/**
 * MapsDirections — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for MapsDirections) without touching
 * the shared engine.
 */
export class MapsDirections extends QuizGame {}
