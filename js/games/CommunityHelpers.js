...
/**
 * CommunityHelpers — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for CommunityHelpers) without touching
 * the shared engine.
 */
export class CommunityHelpers extends QuizGame {}
