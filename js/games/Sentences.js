...
/**
 * Sentences — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for Sentences) without touching
 * the shared engine.
 */
export class Sentences extends QuizGame {}
