...
/**
 * NeedsWants — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for NeedsWants) without touching
 * the shared engine.
 */
export class NeedsWants extends QuizGame {}
