...
/**
 * Phonics — same multiple-choice mechanic as every other quiz-style game
 ...
 * text-to-speech read-aloud button just for Phonics) without touching
 * the shared engine.
 */
export class Phonics extends QuizGame {}
